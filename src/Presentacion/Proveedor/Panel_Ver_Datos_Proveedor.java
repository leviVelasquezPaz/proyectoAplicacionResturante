 ...
 * @author Antonio AB
 */
public class Panel_Ver_Datos_Proveedor extends javax.swing.JDialog {

    /**
     * Creates new form Panel_Ver_Datos_Proveedor
     */
    public Panel_Ver_Datos_Proveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public void limpiarLables() {
        lblCodigo.setText(ProveedorDAO.Id_proveedor);
        lblNombre.setText(ProveedorDAO.Nombre);
        lblApellidoPaterno.setText(ProveedorDAO.A_paterno);
        lblapellidoMaterno.setText(ProveedorDAO.A_materno);
        lblDeni.setText(String.valueOf(ProveedorDAO.DNI));
        lblDeni.setText(String.valueOf(ProveedorDAO.telefono));
        lblDireccion.setText(ProveedorDAO.direccion);
        lblCorreo.setText(ProveedorDAO.E_mail);
        lblEstado.setText(ProveedorDAO.direccion);
    }
...
//            java.util.logging.Logger.getLogger(Panel_Ver_Datos_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                Panel_Ver_Datos_Proveedor dialog = new Panel_Ver_Datos_Proveedor(new javax.swing.JFrame(), true);
